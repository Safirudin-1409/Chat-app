...
const Sidebar = () => {
  ...
  const { getUsers, users, selectedUser, setSelectUser, unseenMessages,setUnseenMessages } = useContext(ChatContext);
          ...
          <div className = "relative py-2 group">
            ...
            cursor-pointer'/>
              ...
              border-gray-600 text-gray-100 hidden group-hover:block">
                ...
                <p onClick = {() => logout()} className = 'cursor-pointer text-sm '>Logout</p>            </div>
          </div>
        </div>
